...
import org.mobicents.slee.sipevent.server.subscription.eventlist.SerializableListType;
...
public class FlatListMakerSbbImpl extends FlatListMakerSbb implements FlatListMakerSbbLocalObject {

	private SerializableListType currentListType;
	private FlatList flatList;
	private SerializableListType[] lists;
	...
	@Override
	public SerializableListType getCurrentListType() {
	...
	@Override
	public SerializableListType[] getLists() {
		return lists;
	}
	...
	@Override
	public void setCurrentListType(SerializableListType value) {
	...
	@Override
	public void setLists(SerializableListType[] value) {
		this.lists = value;
