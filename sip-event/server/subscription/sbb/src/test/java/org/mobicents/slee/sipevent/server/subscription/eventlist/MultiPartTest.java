...
public class MultiPartTest {
	...
	public void test() {
		...
		String s = 
			...
			BodyPart bodyPart1 = new BodyPart(null,"binary","nXYxAE@pres.vancouver.example.com","application","rlmi+xml","UTF-8","body1");
			BodyPart bodyPart2 = new BodyPart(null,"binary","bUZBsM@pres.vancouver.example.com","application","pidf+xml","UTF-8","body2");
			BodyPart bodyPart3 = new BodyPart(null,"binary","ZvSvkz@pres.vancouver.example.com","application","pidf+xml","UTF-8","body3");
